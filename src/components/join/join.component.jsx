...
const Join = () => {
    return (
        <div id="join" className="join-container my-container">
            ...
            <a href="https://www.uusu.org/organisation/21214/" target="_blank" rel="noopener noreferrer">https://www.uusu.org/organisation/21214/</a>
            ...
            <a href="mailto:futuresocietyuu@gmail.com">futuresocietyuu@gmail.com</a>
        </div>
    )
}
export default Join;